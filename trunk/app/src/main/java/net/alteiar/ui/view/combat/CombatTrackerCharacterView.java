...
import net.alteiar.task.combat.ChangeFaction;
import net.alteiar.ui.view.FxmlViewController;

public class CombatTrackerCharacterView extends FxmlViewController implements Initializable {
	...
	private void revalidate() {
		...
		if (characterCombat != null) {
			...
			characterDamage.setText(Integer.valueOf(character.getWounds()).toString());
